	...
	<div class="site-menubar">
		<div class="site-menubar-body">
			<div>
						...
						<?php if ($admin->admin_level_kode === '1') { ?>
							<li class='site-menu-item has-sub'>
								...
								<ul class='site-menu-sub'>
									<li class='site-menu-item'>
										<a href='<?php echo base_url(); ?>website/laporanprofit' class='animsition-link'>
									...
									<li class='site-menu-item'>
										<a href='<?php echo base_url(); ?>website/laporanproduk' class='animsition-link'>
											<i class='site-menu-icon fa fa-angle-right'></i>
											<span class='site-menu-title'>
												Daftar Produk
											</span>
									...
									<li class='site-menu-item'>
										<a href='<?php echo base_url(); ?>website/laporankuantitas' class='animsition-link'>
											<i class='site-menu-icon fa fa-angle-right'></i>
											<span class='site-menu-title'>
												Kuantitas Pesanan
											</span>
				...
				<div>
					<ul class="site-menu">
						<li class="site-menu-category">OLAP</li>
						<li class='site-menu-item'>
							<a href='<?php echo base_url(); ?>website/mondrian' class='animsition-link'>
